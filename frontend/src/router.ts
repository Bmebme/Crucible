...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/graph', name: 'graph', component: () => import('./views/GraphView.vue'), meta: { title: '实体图' } },
    { path: '/mcp-monitor', name: 'mcp-monitor', component: () => import('./views/McpMonitor.vue'), meta: { title: 'MCP 监控' } },
